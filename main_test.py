...
class Game:
    ...
    def run_one_question(self, question_dict: dict):
        ...
        if question_dict['table_type'] == '2':
            answer_dict = {'id': question_dict['id'], 'type': question_dict['type'],
                           'table_type': question_dict['table_type'], 'question': question_dict['question']}
