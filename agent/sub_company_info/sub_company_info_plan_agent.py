...
输出：["调用查子公司的工具：查询北京当升材料科技股份有限公司的所有子公司名称和融资信息。", "调用筛选工具：根据参股比例字段筛选出50%以上的子公司。", "调用筛选工具：根据投资金额字段筛选出5000万以上的子公司。"]

例子2:
问题：金宏气体股份有限公司在子公司投资的总金额达到多少亿人民币？
输出：["调用查子公司的工具：查询金宏气体股份有限公司的所有子公司名称和融资信息。", "调用求和工具：根据投资金额字段求和。"]
...
例子4:
问题：福安药业旗下包含哪些子公司？
输出：["调用查子公司的工具：查询福安药业的所有子公司名称和融资信息。"]

例子5:
问题：请问依米康软件技术（深圳）有限责任公司的上级控股企业是哪一家？他们对它的持股比例如何？他们总共控制几家下属公司？"
输出：["调用找母公司的工具：查询依米康软件技术（深圳）有限责任公司的母公司名称和融资信息。", "调用查子公司的工具：查询该母公司的所有子公司名称和融资信息。"]   
