from agent.sub_company_info.sub_company_info_agent import SubCompanyInfoAgent
import json
...
class Game:
    def __init__(self):
        self.max_threads = 5
        self.question_file_path = 'list_a_data/company_sub_question_with_plan.jsonl'
